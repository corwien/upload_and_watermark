...
class Uploader
{
    ...
    public function addWaterMark()
    {
        ...
        $iinfo=getimagesize($image_url);  //获取图片的相关信息，得到数组
        ...
        switch ($iinfo[2]) {
            case 1:
                $simage =imagecreatefromgif($image_url);
                break;
            case 2:
                $simage =imagecreatefromjpeg($image_url);
                break;
            case 3:
                $simage =imagecreatefrompng($image_url);
                break;
            case 6:
                $simage =imagecreatefromwbmp($image_url);
                break;
            default:
                die("不支持的文件类型");
                exit;
        ...
        switch ($iinfo[2]) {
            case 1:
                imagejpeg($nimage, $image_url); //将图像$nimage以$destination文件名创建一个jpeg的格式文件
                break;
            case 2:
                imagejpeg($nimage, $image_url);
                break;
            case 3:
                imagepng($nimage, $image_url);
                break;
            case 6:
                imagewbmp($nimage, $image_url);
                break;
        }
